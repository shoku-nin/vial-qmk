...
//  9  8  7  6  5   27 26 25 24 23
// 10 11 12 13 14   28 29 30 31 32
//       17 16 15   35 34 33
//
// my_capslock_layer
// ye wh wh wh wh   wh wh wh wh wh
// ye  8  7  6  5   27 26 25 24 23
// 10 11 12 13 14   28 29 30 31 32
//       17 16 15   35 34 33
//
const rgblight_segment_t PROGMEM my_capslock_layer[] = RGBLIGHT_LAYER_SEGMENTS(
    {0, 1, HSV_YELLOW}, { 1, 4, HSV_WHITE},
    {9, 1, HSV_YELLOW}, {18, 5, HSV_WHITE}
);
// my_layer1_layer
// wh  1  2  3  4   bl bl bl bl 22
//  9  8  7  6  5   bl bl bl 24 23
// -- 11 12 13 14   bl bl bl 31 32
//       17 wh 15   35 -- 33
//
const rgblight_segment_t PROGMEM my_layer1_layer[] = RGBLIGHT_LAYER_SEGMENTS(
    {0, 1, HSV_WHITE},   {10, 1, HSV_OFF},
    {16, 1, HSV_WHITE},
//
...
// my_layer2_layer
// wh pi gr pi  4   18 pi gr pi 22
//  9 gr gr gr  5   27 gr gr gr 23
// wh 11 pi 13 14   28 29 30 31 --
//       17 -- 15   35 wh 33
//
const rgblight_segment_t PROGMEM my_layer2_layer[] = RGBLIGHT_LAYER_SEGMENTS(
    {0, 1, HSV_WHITE},  {1, 1, HSV_PINK},
    {2, 1, HSV_GREEN},  {3, 1, HSV_PINK},
    {6, 3, HSV_GREEN},  {10, 1, HSV_WHITE},
    {12, 1, HSV_PINK},  {16, 1, HSV_OFF},
//
...
// my_layer3_layer
// --  1  2  3  4   re re re re 22
//  9  8  7  6  5   re re re gr --
// 10 11 12 13 14   re re re -- wh
//       17 16 15   35 34 33
//
...
const rgblight_segment_t PROGMEM my_layer5_layer[] = RGBLIGHT_LAYER_SEGMENTS(
    {0, 12, HSV_OFF},  {10, 1, HSV_GREEN},
    {11, 1, HSV_OFF},  {12, 1, HSV_WHITE},
    {13, 5, HSV_OFF},
//
    {18, 1, HSV_RED},   {19, 1, HSV_BLUE},
    {20, 6, HSV_OFF},   {26, 1, HSV_BLUE},
    {27, 2, HSV_RED},   {29, 1, HSV_BLUE},
    {30, 1, HSV_WHITE}, {31, 3, HSV_OFF},
