...
[0] = LAYOUT_wrapper(
TO(4),    _______,
_______,_______,_______,    KC_WH_U,KC_BTN1,KC_WH_D,
...
_______,_______,_______,_______,_______,    KC_BTN1,KC_BTN2,_______,_______,_______,
SPD_LO, _______,SPD_HI, _______,_______,    KC_BTN1,KC_BTN2,SPD_HI, _______,_______,
                _______,_______,_______,    _______,SPD_LO, _______
),
