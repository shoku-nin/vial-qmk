...
const rgblight_segment_t PROGMEM my_capslock_layer[] = RGBLIGHT_LAYER_SEGMENTS(
    {3,  1, HSV_WHITE},
    {9,  1, HSV_YELLOW},
    {14, 4, HSV_WHITE},    {18, 1, HSV_YELLOW},
//
    {22, 1, HSV_WHITE},
    {33, 5, HSV_WHITE}
);
...
const rgblight_segment_t PROGMEM my_layer1_layer[] = RGBLIGHT_LAYER_SEGMENTS(
    {1,  1, HSV_WHITE},
    {3,  1, HSV_BLUE},
    {8,  1, HSV_OFF},   {18, 1, HSV_WHITE},
//
    {20, 1, HSV_OFF},
    {22, 1, HSV_BLUE},
    {23, 3, HSV_BLUE},  {30, 7, HSV_BLUE}
);
// my_layer2_layer
...
const rgblight_segment_t PROGMEM my_layer2_layer[] = RGBLIGHT_LAYER_SEGMENTS(
    {1,  1, HSV_OFF},
    {3,  1, HSV_MAGENTA},
    {6,  1, HSV_PINK},  {10, 3, HSV_GREEN},
    {15, 1, HSV_PINK},  {16, 1, HSV_GREEN},
    {17, 1, HSV_PINK},  {18, 1, HSV_WHITE},
//
    {20, 1, HSV_WHITE},
    {22, 1, HSV_MAGENTA},
    {27, 1, HSV_OFF},   {29, 3, HSV_GREEN},
    {34, 1, HSV_PINK},  {35, 1, HSV_GREEN},
    {36, 1, HSV_PINK}
);
// my_layer3_layer
...
//
    {22, 1, HSV_YELLOW},
    {23, 3, HSV_MAGENTA},
    {26, 1, HSV_OFF},   {27, 1, HSV_WHITE},
    {28, 1, HSV_OFF},   {29, 9, HSV_MAGENTA}
);
// my_layer4_layer
// 18 17 16 15 14       33 34 35 36 37
//  9 10 11 12 13       32 31 30 29 28
