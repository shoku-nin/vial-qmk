...
#define _ms_L1_ KC_TRNS,KC_MS_BTN1,KC_UP,KC_MS_BTN2,KC_MS_WH_UP
//#define _ms_L2_ XXXXXXX,KC_MS_LEFT,KC_MS_DOWN,KC_MS_RIGHT,KC_APP
#define _ms_L2_ XXXXXXX,KC_LEFT,KC_DOWN,KC_RIGHT,KC_APP
...
#define _func_L3_ CW_TOGG,KC_LALT,KC_LCTL,KC_LSFT,A(KC_PSCR)
